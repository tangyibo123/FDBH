...
class VitVAE_Cifar(BaseVAE):
    ...
    def __init__(
        ...
        **kwargs
        ...
        pre_logits_size = hidden_dims[-1]
        middle_dim = int(hidden_dims[-1] / 2)

        self.fc_pre = nn.Linear(pre_logits_size , middle_dim)
